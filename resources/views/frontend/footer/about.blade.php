                    ...
                    <div class="content-column col-md-6 col-sm-12 col-xs-12">
                        <div class="inner-column">
                            ...
                            <div class="text">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                ...
                                only
                                five centuries</div>
                            <div class="email">Get In Touch: <span class="theme_color">info@chobidokan.com</span></div>
                            <a href="{{ route('welcome') }}" class="btn-sm theme-btn btn-style-three">Read More</a>
                        </div>
                    </div>
