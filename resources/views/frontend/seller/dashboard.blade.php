                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtbEsykx-0fhTred6UwHDYtMFd2UgTJCG4gaklT1dx4suRO4_n5LJr4Gg28kquSX5fpNo&usqp=CAU" alt="Admin" class="p-1" width="110">
                                <div class="mt-3">
                                    <h4>Mr. Seller</h4>
                            ...
                            <div class="list-group list-group-flush text-center mt-4">
                                <a href="#" class="list-group-item list-group-item-action border-0 active" onclick="showDashboard()">Dashboard</a>
                                <a href="#" class="list-group-item list-group-item-action border-0" onclick="showEarning()">Earnings</a>
                                <a href="#" class="list-group-item list-group-item-action border-0" onclick="showDownloads()">Downloads</a>
                                <a href="#" class="list-group-item list-group-item-action border-0" onclick="showFiles()">Files</a>
                                <a href="#" class="list-group-item list-group-item-action border-0" onclick="logout()">Logout</a>
                            </div>
                        </div>
                    </div>
                </div>
