            ...
            <div class="container my-4">
                <form action="{{ route('custom-job.search') }}" method="GET">
                    <div class="row align-items-end gy-3 mt-5" id="search">
                        <h3 class="text-center">{{ $totalProjects }} Open @if ($totalProjects > 1)
                                Jobs
                            @else
                                Job
                            @endif
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="form-group position-relative">
                                ...
                                <input type="text" id="search-input" name="search" class="form-control ps-4"
                                    placeholder="What are you looking for?">
                                <span class="fa fa-search position-absolute"
                                    style="top: 36px; left: 5px; color: #aaa;"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6">
                            <div class="form-group position-relative">
                                ...
                                <i class="fa fa-chevron-down position-absolute"
                                    style="top: 35px; right: 10px; pointer-events: none; color: #aaa;"></i>
                            </div>
                        </div>
                        ...
                        <div class="job-card shadow-sm">
                            <a href="{{ route('customize-details', $project->id) }}" class="text-dark">
                                <div class="row">
                                    ...
                                    <div
                                        class="col-md-2 col-12 text-center d-flex justify-content-center justify-content-md-start mb-3 mb-md-0 pt-md-2">
                                        {{-- if the job is open --}}
                                        <img class="job-status-icon" src="{{ asset('frontend_assets/img/open.png') }}"
                                            alt="">
                                    ...
                                    <div class="right col-md-3 col-12">
                                        <p class="sidebar-info"><i class="info-icon">&#x1F4B0;</i> Budget :
                                            <strong>{{ $project->order?->amount }} Tk.</strong></p>
                                        @if ($daysLeft == 'Expired')
                                            <p class="sidebar-info"><i class="info-icon">&#x23F3;</i> Submit Time : <strong
                                                    class="text-danger">Expired</strong> </p>
                                        @else
