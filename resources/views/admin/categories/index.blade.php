            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover datatable datatable-category" id="category-dataTable">
                            <thead>
                                <tr>
                                    <th>
...
<script>
    $(function() {
        ...
        initDataTable('#category-dataTable', dtButtons);
    });
</script>
