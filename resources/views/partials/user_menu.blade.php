<div class="col-md-3">
    ...
    <div class="card text-center shadow-sm mb-4">
        <div class="card-body">
            ...
            <p class="card-text d-flex justify-content-center align-items-center">
                <i class="fa fa-phone mr-2"></i>{{ $user->phone }}
            </p>
        </div>
    </div>
    ...
    <div class="list-group shadow-sm">
        ...
        <a href="{{ route('user.about') }}" class="list-group-item list-group-item-action d-flex align-items-center">
        ...
        <a href="{{ route('user.refund-payment-history') }}"
           class="list-group-item list-group-item-action d-flex align-items-center">
            <i class="fa fa-shopping-bag mr-2"></i> Refund Payment History
        </a>
